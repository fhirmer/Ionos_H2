...
const fragen = [
    ...
    },
    {
        ...
        skizze: 'platz',
        labels: ['shutter.armour_close_to_sash', 'shutter.guide_close_left', 'shutter.guide_close_right', 'shutter.guide_close_hinge_side'],
        antworten: [
            {id: 'genug', text: 'Ja, überall genug Platz', hinweis: 'ringsum mindestens fingerbreit frei',
                setzt: {'shutter.armour_close_to_sash': false, 'shutter.guide_close_left': false, 'shutter.guide_close_right': false, 'shutter.guide_close_hinge_side': false}},
